...
import logging
class Trainer:
    def __init__(self, db_folder='F:\\GP\\Repo\\Attendance-System\\Computer-vision\\db'):
    ...
    def train(self):
        ...
        with open('F:\\GP\Repo\\Attendance-System\\Computer-vision\\known_encodings.pkl', 'wb') as f:
