...
# class Recognizer:
#     def __init__(self, db, semester_id, course_id, lecture_id, status, confidence_threshold=0.1, buffer_size=5):
#         self.db = db
...
#         encodings_dir = 'F:\\GP\\Repo\\Attendance-System\\Computer-vision\\last_for_deploy\\db'
