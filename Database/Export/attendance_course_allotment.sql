...
CREATE TABLE `course_allotment` (
  ...
  CONSTRAINT `course_allotment_ibfk_2` FOREIGN KEY (`session_id`) REFERENCES `semester_details` (`session_id`),
  ...
  CONSTRAINT `fk_course_allotment_session_id` FOREIGN KEY (`session_id`) REFERENCES `semester_details` (`session_id`),
